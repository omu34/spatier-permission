        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="URL::to('admin.users.index')" :active="request()->routeIs('admin.users.index')">
                        {{ __('Users') }}
                    </x-nav-link>
                    @endif
                    {{-- @endcan --}}
                    ...
                    <x-nav-link :href="URL::to('business.businesses.index')" :active="request()->routeIs('business.businesses.index')">
                        {{ __('Business Class') }}
                    </x-nav-link>
                    <x-nav-link href="URL::to('product.index')" :active="request()->routeIs('product.index')">
                    ...
                    <x-nav-link :href="URL::to('employee.clients.index')" :active="request()->routeIs('employee.clients.index')">
                        {{ __('Employees') }}
                    </x-nav-link>
                    @endif
                    {{-- @endcan --}}
